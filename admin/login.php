...
.left-panel{
  background:linear-gradient(145deg,#1e1f3b 0%,#1c1d1f 60%,#0f1117 100%);
...
.left-badge{
  ...
  color:#a5b4fc;padding:5px 16px;border-radius:20px;font-size:.78rem;font-weight:700;
...
.left-inner h2 span{color:#6366f1;}
...
.feature-icon{
  width:36px;height:36px;border-radius:8px;background:rgba(99,102,241,.15);
...
.login-logo-text span{color:#6366f1;}
...
.show-pass{
  ...
  background:none;border:none;cursor:pointer;color:#4b5563;padding:2px;transition:color .2s;
}
    ...
    <div class="left-inner">
      ...
      <div class="features">
        <div class="feature">
          ...
          <div class="feature-text"><strong>Upload de vidéos</strong><span>Ajoutez vos tutoriels MP4 par thème</span></div>
        </div>
        <div class="feature">
          <div class="feature-icon">📁</div>
          <div class="feature-text"><strong>Gestion des thèmes</strong><span>Créez, renommez ou supprimez des catégories</span></div>
        </div>
        <div class="feature">
          <div class="feature-icon">👤</div>
          <div class="feature-text"><strong>Utilisateurs</strong><span>Gérez les accès et les rôles</span></div>
        </div>
        <div class="feature">
          <div class="feature-icon">📊</div>
          <div class="feature-text"><strong>Statistiques</strong><span>Suivez les vues et l'activité</span></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="right-panel">
    <div class="login-box">
      <div class="login-logo">
        ...
        <div class="login-logo-text">Forma<span>Pro</span></div>
      </div>
      <h1>Connexion</h1>
      ...
      <p class="login-footer">
        Mot de passe oublié ? <a href="../setup.php">Réinitialiser via setup.php</a>
      </p>
    </div>
  </div>
